...
<body>
    ...
    <div class="col-md-6">
        ...
        <form action="?c=categorias&a=ActualizarCategoria" method="post">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $categoria['nombre'];?>" required><br><br>
            ...
            <button type="button" class="btn btn-danger btn-md w-100 mt-2" onclick="confirmarEliminacion(<?php echo $categoria['ID_categoria']; ?>)">Eliminar</button>
